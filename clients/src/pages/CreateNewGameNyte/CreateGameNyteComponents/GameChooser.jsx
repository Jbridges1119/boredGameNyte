...
const GameChooser = (props) => {
  ...
  let game1 = getGameById(
    props.state.collection,
    props.newGameNyte.gamesChosen[0]
  );
  let game2 = getGameById(
    props.state.collection,
    props.newGameNyte.gamesChosen[1]
  );
  let game3 = getGameById(
    props.state.collection,
    props.newGameNyte.gamesChosen[2]
  );
