...
<Typography sx={{ color: "#FFFFFF",borderRadius: "20px" }}  variant="h6" >{props.date} {props.time}</Typography>
      ...
      alignContent:'center',
              ...
              <GameBanner name={props.game1.name} img={props.game1.thumb_url}/>
              <GameBanner name={props.game2.name} img={props.game2.thumb_url}/>
              <GameBanner name={props.game3.name} img={props.game3.thumb_url}/>
              </AccordionDetails>
            </Accordion>
