...
export default function Home(props) {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3005/api/gamenytes/attended/${props.userId}`)
      .then((data) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3005/api/gamenytes/host/${props.userId}`)
      .then((data) => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3005/api/gamenytes/hosted/${props.userId}`)
      .then((data) => {
  ...
  let gameNytesHosted = gameNytes.map((nyte) => {
    ...
    return (
      <GameNyteCard
        ...
        game2={
          getGameById(props.state.globalCollection, nyte.bgatlas_game_2) || null
        }
        game3={
          getGameById(props.state.globalCollection, nyte.bgatlas_game_3) || null
        }
      />
    );
  });
